...
namespace Project.Random.Questions.Services
{
...
<table style=""font-family:georgia,palatino;"" role=""presentation"" cellpadding=""0"" cellspacing=""0"" width=""100%"" border=""0"">
  ...
  <div style=""line-height: 140%; text-align: center; word-wrap: break-word;"">
    <p style=""font-size: 14px; line-height: 140%;""><span style=""font-size: 30px; line-height: 42px;"">{message}</span></p>
  </div>
